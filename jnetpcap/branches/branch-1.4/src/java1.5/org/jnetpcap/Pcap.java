...
public class Pcap {
	 ...
	 * {@link #compile(PcapBpfProgram, String, int, int)}() except that instead of
	 ...
	 * {@link #compile(PcapBpfProgram, String, int, int)}_nopcap() is a wrapper
	 * around pcap_open_dead(), {@link #compile(PcapBpfProgram, String, int, int)}
	 * (), and pcap_close(); the latter three routines can be used directly in
	 ...
	 * {@link Direction#OUT} or {@link Direction#INOUT}. {@link Direction#IN} will
	 * only capture packets received by the device, {@link Direction#OUT} will
	 * only capture packets sent by the device and {@link Direction#INOUT} will
	 * capture packets received by or sent by the device. {@link Direction#INOUT}
