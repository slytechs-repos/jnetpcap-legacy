...
public interface JAnalyzer {
	...
	/**
	 * Checks if the analyzer is enabled and running.
	 * 
	 * @return true if analyzer is enabled, otherwise false
	 */
//	public boolean isEnabled();

	/**
	 * Enables or disables the analyzer. The analyzer can be disabled by setting
	 * enable to false. The analyzer will stop processing packets, events and
	 * dispatches to other handlers.
	 * 
	 * @param state
	 *          true to enable the analyzer, otherwise false
	 * @return old value
	 */
