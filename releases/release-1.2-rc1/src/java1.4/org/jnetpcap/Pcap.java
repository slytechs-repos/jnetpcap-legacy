...
public class Pcap {
	 ...
	 *          error buffer containing error message as a string on failure
	 */
	public static void freeAllDevs(List alldevs, byte[] errbuf) {
	 ...
	 *         loop and thread
	 */
	public PcapTask dispatchInBackground(int cnt, PcapHandler handler,
	    final Object data) {
	 ...
	 *         loop and thread
	 */
	public PcapTask loopInBackground(int cnt, PcapHandler handler,
	    final Object data) {
